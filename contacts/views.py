...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, "You already make an inquiry about this car. Please wait until we get back to you")
        ...
        contact.save()
        messages.success(request, "You send message successfully!")
        return redirect('/cars/' + car_id)
